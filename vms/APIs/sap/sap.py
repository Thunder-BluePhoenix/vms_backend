                    ...
                    for gst_table in vcd.comp_gst_table:
                        ...
                        try:
                            ...
                            data = {
                                ...
                                "Banka": "",
                                "Koinh": (onb_pmd.name_of_account_holder[:50] if onb_pmd.name_of_account_holder else ""),  # apply char limit 50
                                "Xezer": "",
...
# =====================================================================================
# DEPRECATED / LEGACY CODE (FOR REFERENCE ONLY) / OLD CODE SNIPPETS
# =====================================================================================
# --- IGNORE ---
