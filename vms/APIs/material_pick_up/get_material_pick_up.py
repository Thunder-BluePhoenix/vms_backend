...
# vms.APIs.material_pick_up.get_material_pick_up.get_material_pick_up_details
@frappe.whitelist()
def get_material_pick_up_details(name):
    try:
        ...
        # Get the document
        material_pick_up = frappe.get_doc("Material Pickup Request", name)
        
        # Convert to dictionary and include all fields
        doc_dict = material_pick_up.as_dict()
...
# vms.APIs.material_pick_up.get_material_pick_up.get_material_pick_up_list
@frappe.whitelist()
def get_material_pick_up_list(filters=None, fields=None, limit=20, offset=0, order_by=None):
    try:
        ...
        total_count = frappe.db.count("Material Pickup Request", filters)
...
#vms.APIs.material_pick_up.get_material_pick_up.get_material_pick_up_statistics
@frappe.whitelist()
def get_material_pick_up_statistics(filters=None):
    try:
        # Check permission
        if not frappe.has_permission("Material Pickup Request", "read"):
            frappe.response.http_status_code = 403
            return {"message": "Failed", "error": "You don't have permission to view Material Pickup Request statistics"}
        ...
        frappe.response.http_status_code = 500
        frappe.log_error(frappe.get_traceback(), "Material Pickup Request Statistics Error")
        return {"message": "Failed", "error": str(e)}