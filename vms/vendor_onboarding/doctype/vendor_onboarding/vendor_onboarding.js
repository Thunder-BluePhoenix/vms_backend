...
function generate_universal_scrollable_version_history(frm) {
    if (!frm.doc.version_history || frm.doc.version_history.length === 0) {
        frm.fields_dict['history_html'].html(`
            <div style="text-align: center; padding: 40px; color: #6c757d; background: #f8f9fa; border-radius: 8px; border: 1px solid #e9ecef;">
                ...
                <h5 style="margin: 0; font-weight: 500;">Version History Not Available</h5>
                <p style="margin: 8px 0 0 0; font-size: 13px;">All modifications to the Purchasing Data tab fields will be systematically tracked and maintained in this section</p>
            </div>
        `);
        return;
    }
    ...
    const isOnb = doctype === 'Vendor Onboarding';
